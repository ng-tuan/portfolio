...
const SiteBarLeft: React.FC = () => {
  return (
    <div className="absolute flex items-center flex-col  bottom-0 right-0 mr-6  h-[50vh] max-lg:hidden ">
      ...
      <div className="flex items-center justify-center flex-col h-[70%] pr-8">
